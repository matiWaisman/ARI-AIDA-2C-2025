    ...
    <>
      ...
      <div className="certificate-container">
        ...
        <div className="university-header">
          <div className="university-name">UNIVERSIDAD DE BUENOS AIRES</div>
          <div className="university-subtitle">
            [Facultad - Dirección completa - Ciudad - País]
          </div>
        </div>
        ...
        <div className="certificate-body">
          ...
          <div className="student-data">
            <div className="data-field">
              <span className="data-label">Número de Libreta:</span>
              <span>{lu}</span>
            </div>
            <div className="data-field">
            ...
            <div className="data-field">
              <span className="data-label">Título Obtenido:</span>
              <span>{titulo}</span>
            </div>
            <div className="data-field">
        ...
        <div className="signature-area">
          ...
          <div className="signature-box">
            <div className="signature-line"></div>
            <div className="signature-label">Sello de la Institución</div>
          </div>
        </div>

        <div className="certificate-footer">
          <p>
            Certificado emitido electrónicamente - Para verificar la
            autenticidad contactar con [correo de la facultad]
          </p>
        </div>
      </div>
    </>
