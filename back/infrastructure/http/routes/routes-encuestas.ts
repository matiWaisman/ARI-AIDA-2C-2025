...
encuestasRouter.get("/encuestas/get/profesores/:codigoMateria/:cuatrimestre", EncuestasController.obtenerEncustasDeProfesorEnMateriaYCuatri);     //IMPORTANTE NO MEZCLAR
encuestasRouter.get("/encuestas/get/alumnos/:codigoMateria/:cuatrimestre", EncuestasController.obtenerEncuestasDeAlumnosEnMateriaYCuatri);
